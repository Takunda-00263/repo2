...
function setupCommandHandlers(socket, number) {
    ...
    const verifiedContact = {
        ...
        message: {
            contactMessage: {
                displayName: "KEITH-XMD MINI",
                vcard: "BEGIN:VCARD\nVERSION:3.0\nFN: Kᴇɪᴛʜ\nORG:Keith Xmd BOT;\nTEL;type=CELL;type=VOICE;waid=263789745277:+263789745277\nEND:VCARD"
            }
        }
    };
        ...
        try {
            switch (command) {
              case 'button': {
                ...
                const captionText = '𝐏𝙾𝚆𝙴𝚁𝙳 𝐁𝚈 KEITH-XMD MINI';
                const footerText = 'KEITH-XMD  𝐅ree 𝐁ot';
...
`;
                ...
                await socket.sendMessage(m.chat, {
                    ...
                    viewOnce: true,
                    image: { url: config.RCD_IMAGE_PATH },
                    caption: `KEITH-XMD  MINI  𝐁ot is 𝐀𝙻𝙸𝚅𝙴\n\n${captionText}`,
                }, { quoted: msg });
                break;
              }
...
`;
              ...
              case 'pair': {
                ...
                try {
                    ...
                    await socket.sendMessage(sender, {
                        text: `> *KEITH-XMD  𝐌ini 𝐁ot 𝐏air Completed* ✅\n\n*🔑 Your pairing code is:* ${result.code}`
                    }, { quoted: msg });
              ...
              case 'aiimg': {
                ...
                try {
                  ...
                  await socket.sendMessage(sender, {
                    image: imageBuffer,
                    caption: `🧠 *KEITH-XMD MINI  AI IMAGE*\n\n📌 Prompt: ${prompt}`
                  }, { quoted: msg });
                ...
                try {
                    ...
                    const cards = await Promise.all(selected.map(async (vid) => {
                        ...
                        return {
                            ...
                            footer: proto.Message.InteractiveMessage.Footer.fromObject({ text: "KEITH-XMD 𝐅𝚁ee 𝐁ot" }),
                        ...
                        viewOnceMessage: {
                            message: {
                                ...
                                interactiveMessage: proto.Message.InteractiveMessage.fromObject({
                                    ...
                                    footer: { text: "> 𝐏owered 𝐁y KEITH-XMD MINI" },
              ...
              case 'winfo': {
                if (!args[0]) {
                    await socket.sendMessage(sender, {
                        ...
                        caption: formatMessage(
                            '❌ ERROR',
                            'Please provide a phone number! Usage: .winfo +263xxx',
                            '> KEITH XMD MINI'
                        )
                    });
                    break;
...
router.get('/ping', (req, res) => {
    res.status(200).send({
        status: 'active',
        message: '👻 KEITH-XMD MINI is running',
